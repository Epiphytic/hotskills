// vendored-from-START
// Source: https://github.com/vercel-labs/skills (src/source-parser.ts)
// Sync SHA: bc21a37a12b90fcb5aec051c91baf5b227b704b1 (tag v1.5.1)
// Sync date: 2026-04-23
// License: MIT (see ./LICENSE)
// Modifications: import path adjusted from './types.ts' to './types.js' for
//   ESM/NodeNext resolution under hotskills' tsconfig (see ./patches/import-extensions.patch)
// vendored-from-END
